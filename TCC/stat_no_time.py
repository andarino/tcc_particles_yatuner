...
# Tuning process!
tuner.initialize()
tuner.test_run(num_samples=200, warmup=20) 
tuner.hypotest_optimizers(num_samples=10, num_epochs=60)
tuner.hypotest_parameters(num_samples=10)
#tuner.optimize(num_samples=20, num_epochs=10) #Using bayesian optimization 
